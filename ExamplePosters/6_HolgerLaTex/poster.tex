...
\documentclass[final,hyperref={pdfpagelabels=false}, professionalmath, mathserif, 18pt]{beamer}
...
% You have to provide defintions here, since the template expects them
  ...
  % \myTitle
  \newcommand\myTitle{Age and transit time for non-autonomous compartmental systems}
  
  % \myDepartment 
  \newcommand\myDepartment{Theoretical Ecosystem Ecology, Department Biogeochemical Processes }
